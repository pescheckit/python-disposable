...
*Generated automatically. Last build: **2026-05-12 03:23 UTC**.*  
*Last DNS snapshot: **2026-05-12T03:10:00+00:00**.*
...
| List | Domains |
|---|---|
| `domains.txt` (default) | 72,165 |
| `domains_strict.txt` | 72,196 |
| `domains_inferred.txt` (opt-in) | 0 |

## Reachability

Of **72,459** resolved domains:

| Status | Count | % of resolved |
|---|---|---|
| MX_OK | 10,871 | 15.0% |
| A_ONLY | 1,476 | 2.0% |
| NXDOMAIN | 19,403 | 26.8% |
| NO_RECORDS | 224 | 0.3% |
| TIMEOUT | 40,485 | 55.9% |

**12,347 domains are mail-reachable today** (17.0%). The remainder are historical: domains that no longer resolve (NXDOMAIN) but are kept on the list because disposable operators frequently re-register such names.
...
| `162.159.205.23` | 254 | 256 |
| `162.159.205.24` | 254 | 256 |
| `162.159.205.25` | 254 | 256 |
