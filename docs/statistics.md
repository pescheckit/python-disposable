...
*Generated automatically. Last build: **2026-05-26 03:19 UTC**.*  
*Last DNS snapshot: **2026-05-26T03:11:10+00:00**.*
...
| List | Domains |
|---|---|
| `domains.txt` (default) | 72,311 |
| `domains_strict.txt` | 72,342 |
| `domains_inferred.txt` (opt-in) | 1 |

## Reachability

Of **72,673** resolved domains:

| Status | Count | % of resolved |
|---|---|---|
| MX_OK | 10,757 | 14.8% |
| A_ONLY | 1,645 | 2.3% |
| NXDOMAIN | 19,787 | 27.2% |
| NO_RECORDS | 243 | 0.3% |
| TIMEOUT | 40,241 | 55.4% |

**12,402 domains are mail-reachable today** (17.1%). The remainder are historical: domains that no longer resolve (NXDOMAIN) but are kept on the list because disposable operators frequently re-register such names.
