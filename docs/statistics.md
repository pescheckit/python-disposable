...
*Generated automatically. Last build: **2026-05-23 04:46 UTC**.*  
*Last DNS snapshot: **2026-05-23T04:46:29+00:00**.*
...
| List | Domains |
|---|---|
| `domains.txt` (default) | 72,319 |
| `domains_strict.txt` | 72,350 |
| `domains_inferred.txt` (opt-in) | 1 |

## Reachability

Of **72,654** resolved domains:

| Status | Count | % of resolved |
|---|---|---|
| MX_OK | 10,742 | 14.8% |
| A_ONLY | 1,645 | 2.3% |
| NXDOMAIN | 19,782 | 27.2% |
| NO_RECORDS | 243 | 0.3% |
| TIMEOUT | 40,242 | 55.4% |

**12,387 domains are mail-reachable today** (17.0%). The remainder are historical: domains that no longer resolve (NXDOMAIN) but are kept on the list because disposable operators frequently re-register such names.
...
| `91.196.52.205` | 531 | 662 |
| `142.132.166.12` | 482 | 495 |
| `188.166.111.252` | 482 | 495 |
| `116.202.9.167` | 467 | 479 |
| `46.101.111.206` | 467 | 479 |
...
*… and 1,498 more. Full list available by querying the SQLite directly.*
