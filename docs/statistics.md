...
*Generated automatically. Last build: **2026-07-22 03:23 UTC**.*  
*Last DNS snapshot: **2026-07-22T03:07:35+00:00**.*
...
| List | Domains |
|---|---|
| `domains.txt` (default) | 74,558 |
| `domains_strict.txt` | 74,589 |
| `domains_inferred.txt` (opt-in) | 0 |

## Reachability

Of **75,249** resolved domains:

| Status | Count | % of resolved |
|---|---|---|
| MX_OK | 11,732 | 15.6% |
| A_ONLY | 1,888 | 2.5% |
| NXDOMAIN | 19,388 | 25.8% |
| NO_RECORDS | 257 | 0.3% |
| TIMEOUT | 41,984 | 55.8% |
...
| `mx4.beavis99.com` | 557 | 558 |  |
| `mx4.beavis99.net` | 557 | 558 |  |
| `route1.mx.cloudflare.net` | 513 | 522 | yes |
| `route2.mx.cloudflare.net` | 513 | 522 | yes |
| `route3.mx.cloudflare.net` | 511 | 520 | yes |
| `generator.email` | 381 | 518 |  |
| `tinyhost.shop` | 337 | 337 |  |
| `park-mx.above.com` | 294 | 296 | yes |
| `email.gravityengine.cc` | 263 | 263 |  |
...
| `mx37.m1bp.com` | 138 | 138 |
| `mx37.mb5p.com` | 138 | 138 |
...
|---|---|---|
| `78.47.124.133` | 870 | 870 |
| `94.130.108.80` | 870 | 870 |
| `116.202.9.167` | 473 | 513 |
| `46.101.111.206` | 473 | 513 |
| `142.132.166.12` | 457 | 497 |
| `188.166.111.252` | 457 | 497 |
| `91.196.52.205` | 452 | 635 |
| `188.245.74.208` | 429 | 430 |
| `195.201.18.63` | 409 | 410 |
...
| Metric | Value |
|---|---|
| High-confidence disposable MX hosts (≥5 disposables, not shared) | 198 |
