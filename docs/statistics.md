...
*Generated automatically. Last build: **2026-07-20 03:20 UTC**.*  
*Last DNS snapshot: **2026-07-20T03:06:19+00:00**.*
...
| List | Domains |
|---|---|
| `domains.txt` (default) | 74,542 |
| `domains_strict.txt` | 74,573 |
| `domains_inferred.txt` (opt-in) | 0 |

## Reachability

Of **75,224** resolved domains:
...
**13,964 domains are mail-reachable today** (18.6%). The remainder are historical: domains that no longer resolve (NXDOMAIN) but are kept on the list because disposable operators frequently re-register such names.
...
*… and 1,680 more. Full list available by querying the SQLite directly.*
